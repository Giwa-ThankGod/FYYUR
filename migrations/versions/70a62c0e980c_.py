...
Revision ID: 70a62c0e980c
Revises: cc3db19229ae
Create Date: 2022-09-11 16:28:40.643688
...
revision = '70a62c0e980c'
down_revision = 'cc3db19229ae'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('seeking_venue', sa.VARCHAR(length=500), autoincrement=False, nullable=True),
